...
public class AdministrationSystemResponseExceptionMapper implements ResponseExceptionMapper<Throwable> {
    ...
    /**
     * Maps http error responses from the administration system to the
     * RepairServiceException
     */
    @Override
	...
	case 400:
	    ...
	    break;
	/*
	 * case 401: message = "Unauthorized"; break; case 403: message = "Forbidden";
	 * break; case 404: message = "NOT FOUND"; break; case 500: message =
	 * "Internal server error in administration system."; break;
	 */
	default:
	...
	return new RepairServiceException(ResponseEntity.status(status).body(new ErrorResponseDto(status, message)));
    }
